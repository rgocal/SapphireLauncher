...
public class IconPackHelper {
    ...
    public static void pickIconPack(final Context context, final boolean pickIcon) {
        ...
        if (supportedPackages.isEmpty()) {
            ...
            alertDialog.setTitle("No Icon Packs Detected");
            alertDialog.setMessage("It appears you don't have any Icon Packs installed...");
            alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, ("Search on Google Play"),
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/0wgMLE"));
        ...
        builder.setNeutralButton("Get More", new DialogInterface.OnClickListener() {
