...
public class Alarm implements Runnable{
    ...
    private com.NxIndustries.Sapphire.OnAlarmListener mAlarmListener;
    ...
    public void setOnAlarmListener(com.NxIndustries.Sapphire.OnAlarmListener alarmListener) {
