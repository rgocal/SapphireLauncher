...
public class SelectAction extends PreferenceActivity implements OnPreferenceClickListener, Runnable {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try{
			...
			addPreferencesFromResource(R.xml.select_action);
			t = new Thread(this);
			t.start();
		}catch(Exception E){
	...
	private void initSettings(){
		...
		toggleWifi = findPreference("keyToggleWifi");
		turnOnWifi = findPreference("keyTurnOnWifi");
		turnOffWifi = findPreference("keyTurnOffWifi");
		wifiSettings = findPreference("keyWifiSettings");

		toggleBt = findPreference("keyToggleBlueTooth");
		turnOnBt = findPreference("keyTurnOnBlueTooth");
		turnOffBt = findPreference("keyTurnOffBlueTooth");
		turnBtVisibility = findPreference("keyTmpBluetoothVisible");
		btSettings = findPreference("keyBluetoothSettings");

		toggleDataConnectivity = findPreference("keyToggleData");
		turnOffDataConnectivity = findPreference("keyTurnOnData");
		turnOnDataConnectivity = findPreference("keyTurnOffData");
		dataConnectivitySettings = findPreference("keyDataSettings");

		toggleSync = findPreference("keyToggleSync");
		turnOffSync = findPreference("keyTurnOnSync");
		turnOnSync = findPreference("keyTurnOffSync");
		syncSettings = findPreference("keySyncSettings");

		toggleBrightness = findPreference("keyToggleBrightness");
		minBrightness = findPreference("keyMinBrightness");
		medBrightness = findPreference("keyMediumBrightness");
		maxBrightness = findPreference("keyMaxBrightness");
		displaySettings = findPreference("keyDisplaySettings");

		togggleSound = findPreference("keyToggleSound");
		muteSound = findPreference("keyMuteSound");
		vibrateSound = findPreference("keyVibrateSound");
		normalSound = findPreference("keyNormalSound");
		soundSettings = findPreference("keySoundSettings");
		/*
		...
		turnOnFlash = findPreference("keyTurnOnFlash");
		turnOffFlash = findPreference("keyTurnOffFlash");

		openGPSSettings = findPreference("keyOpenGPSSettings");
		openFlightModeSettings = findPreference("keyOpenFlightModeSettings");
		openBatteryInfo = findPreference("keyOpenBatteryInfo");
		openFile = findPreference("keyOpenFile");
		openTether = findPreference("keyOpenTether");

		prefOpenURL = (PreferenceScreen)findPreference("keyOpenURL");
		callMailMsg = findPreference("keyCallMailMsgSettings");
		try{
			if (hasFlash()) {
