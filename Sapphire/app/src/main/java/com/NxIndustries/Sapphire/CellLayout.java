...
public class CellLayout extends ViewGroup {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mOverScrollRight.setTint(SettingsProvider.getInt(mLauncher,
                SettingsProvider.KEY_SCROLL_RIGHT, R.color.white));
        mOverScrollLeft.setTint(SettingsProvider.getInt(mLauncher,
                SettingsProvider.KEY_SCROLL_LEFT, R.color.white));
        mForegroundPadding =
