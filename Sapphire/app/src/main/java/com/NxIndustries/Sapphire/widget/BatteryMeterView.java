...
import com.NxIndustries.Sapphire.util.ResUtils;
...
public class BatteryMeterView extends TextView {
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            ...
            mColors = new int[]{
                    4, res.getColor(R.color.red),
                    15, res.getColor(R.color.white),
                    100, res.getColor(R.color.blue),
            };
        }

        mChargeColor = getResources().getColor(R.color.orange);
    ...
    protected class NormalBatteryMeterDrawable implements BatteryMeterDrawable {
        ...
        public NormalBatteryMeterDrawable(Resources res) {
            ...
            mFramePaint.setColor(res.getColor(R.color.htc_grey));
            ...
            mBoltPaint.setColor(res.getColor(R.color.black));
