...
public class GestureButtonFragment extends SettingsPreferenceFragmentStock
    ...
    public static GestureButtonFragment newInstance() {
        return new GestureButtonFragment();
    }
