...
package com.NxIndustries.Sapphire.palette;
...
public final class Palette {
    ...
    public boolean equals(Object o) {
        ...
        return mVibrantSwatch != null ? mVibrantSwatch.equals(palette.mVibrantSwatch) : palette.mVibrantSwatch == null;
    ...
    public static final class Swatch {
        ...
        public String toString() {
            return new StringBuilder(getClass().getSimpleName())
                    ...
                    .append(" [Title Text: #")
                    .append(Integer.toHexString(mTitleTextColor)).append(']')
                    .append(" [Body Text: #")
                    .append(Integer.toHexString(mBodyTextColor)).append(']')
                    .toString();
        }
