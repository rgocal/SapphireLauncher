...
public class DeviceProfile {
    ...
    interface DeviceProfileCallbacks {
    ...
    DeviceProfile(Context context,
        ...
        hideDock = SettingsProvider.getBoolean(context,
                SettingsProvider.KEY_DOCK, true);
        ...
        //PageIndicator
        showPageIndicator = SettingsProvider.getBoolean(context,
                SettingsProvider.KEY_PAGE_INDICATOR, true);

        //ChevronBar
        showChevronBar = SettingsProvider.getBoolean(context,
    ...
    void updateFromConfiguration(Context context, Resources resources, int wPx, int hPx,
        ...
        isLayoutRtl = Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1 && (configuration.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL);
        widthPx = wPx;
        heightPx = hPx;
     ...
     */
    private Rect getSearchBarBounds(int orientation) {
    ...
    private int calculateOverviewModeWidth(int visibleChildCount) {
    ...
    public void layout(Launcher launcher) {
        ...
        // Layout the chevron bar
        chevronBar = launcher.findViewById(R.id.chevron_apps);
        chevronBar.setVisibility(showChevronBar ? View.VISIBLE : View.GONE);
        ...
        if (pageIndicator != null) {
            if (hasVerticalBarLayout) {
                ...
                pageIndicator.setVisibility(showPageIndicator ? View.VISIBLE : View.GONE);
            } else {
